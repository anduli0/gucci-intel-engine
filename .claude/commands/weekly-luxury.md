...
1. WATCH (parallel ×5): use the luxury-brand-watcher subagent per group IN PARALLEL (Kering / LVMH / Hermes-Chanel / Jewelry / Beauty), passing BRAND_GROUP, DATE=WEEK_END, MODE=weekly. Each writes data/luxury/{WEEK_END}/{BRAND_GROUP}.json.
